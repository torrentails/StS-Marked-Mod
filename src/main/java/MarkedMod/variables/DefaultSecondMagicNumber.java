package MarkedMod.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import MarkedMod.cards.AbstractDefaultCard;

import static MarkedMod.MarkedMod.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    public String key() {
        ...
        // Remember, we're using makeID so it automatically puts "MarkedMod:" (or, your id) before the name.
    }
