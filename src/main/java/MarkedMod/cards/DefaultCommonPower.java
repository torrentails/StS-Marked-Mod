...
import MarkedMod.characters.TheDefault;
import MarkedMod.powers.CommonPower;
...
public class DefaultCommonPower extends AbstractDynamicCard {
    ...
    public static final String ID = MarkedMod.makeID(DefaultCommonPower.class.getSimpleName());
    ...
    // Go check out DefaultAttackWithVariable and MarkedMod.variable.DefaultCustomVariable
